...
class NinthHousePlanetViewController2: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        venusHouse8.text = "For you, beliefs come directly from experiences that take you beyond the tyranny of the familiar and stretch your mind to venture beyond its comfort zone. They might involve travel. They are always  “educational” in some sense. It is as if you are a puzzle – and the missing pieces that truly complete you are out there in the wide world, beyond your immediate horizons."
...
//
        ...
        plutoFirstHeading1.text = "Above All, Believe"
...
//
         ...
         moonSignText.text = "That the ultimate purpose of your life is a quest for meaning. Everything else is secondary. You were born with the seeds of genuine philosophical wisdom. Never lose sight of the fact that if you boldly follow the adventurous path of your destiny, by the end of this lifetime your wisdom will be seven times deeper."
...
//
         ...
         moonHouseHeading.text = "Never Underestimate"
...
//
         ...
         moonHouseText.text = "The triggering impact on your consciousness of contact with other cultures and other systems of belief. The expansion of your wisdom in this incarnation depends on encounters with exotic thoughts and ideas, along with exotic societies and people who represent alien perspectives. These experiences nourish you. Predictability does not. "
...
//
         ...
         venusHouseHeading1.text = "Your Gift from the Gods"
...
//
         ...
         venusHouseText1.text = "You intuitively and quickly figure out how to build bridges across cultural divides. You are a good traveler. You have a genuine enthusiasm for learning; you enjoy it and are motivated to live a life of endless education. Life offers you these opportunities; they seem to fall out of the clear blue sky into your lap."
         ...
         venusHouseHeading2.text = "When too much Faith gets in the way"
         ...
         venusHouseText2.text = "You become convinced of the absolute validity of your own opinions. You become, in your own mind, an expert. In place of intellectual expansion, you experience intellectual stasis. Behind your back, people warn each other, “Don’t get him (or her) started…”"
