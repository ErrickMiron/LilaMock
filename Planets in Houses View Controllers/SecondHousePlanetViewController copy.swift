//
//  SecondHousePlanetViewController.swift
//  MVP
//
...
class SecondHousePlanetViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        var uranusHouse2 = UILabel(frame: CGRect(x: 20, y: 45, width: 325, height: 120))
        uranusHouse2.text = "How much power do you want to give to mere money in shaping your life? Even more importantly, how closely do you want to follow the standard social script of “practical” values around it? To live the life you were born to live, Lila thinks you need to think outside the usual financial boxes."
        uranusHouse2.textColor = .white
        uranusHouse2.font = .systemFont(ofSize: 13)
         scrollView.addSubview(uranusHouse2)
        uranusHouse2.lineBreakMode = .byWordWrapping
        uranusHouse2.numberOfLines = 0
...
//
        ...
        plutoFirstHeading1.text = "Making a radical commitment to thinking and acting for yourself?"
...
//
         ...
         moonSignText.text = "I resolve that my self-confidence and my dignity arise 100% from my integrity – and 0% from other people’s approval. I prove myself to myself by making bold and risky moves in uncharted directions. I do not care if they impress anyone else; I only need them to impress me. I declare my independence from the money-myths of this world. I need food and shelter, but I vigorously renounce the need for any ego-boost that comes from impressing anybody with my financial status. As the brilliant jazz innovator and mentor, Art Blakey, put it, ““You can’t just think about making money. Because you ain’t never going to see an armored car following a hearse.”"
...
//
         ...
         moonHouseHeading.text = "Qualities of character that support you in fulfilling that intention"
...
//
         ...
         moonHouseText.text = "The more I distance myself from the need to elicit applause from anyone, the wiser, happier, and freer I become. I have a strong innate potential for figuring out a way to be financially self-sustaining – perhaps through an innovative approach to self-employment or perhaps through paring down my material needs. Such an independent and individuated relationship to money would be an enormous support to my fulfilling my evolutionary intentions; it would free me to reach them."
...
//
         ...
         venusHouseHeading1.text = "Getting this right"
...
//
         ...
         venusHouseText1.text = "Oscar Wilde once said, “I put all my genius into my life; I put only my talent into my works.” If I get this configuration right, I will be able to say that too."
         ...
         venusHouseHeading2.text = "The Prize"
         ...
         venusHouseText2.text = "A feeling of empowerment that does not go straight to my ego, but rather feels like I am simply being myself. If I succeed, I become a leader or a role model for others who are ready to face life’s true complexity. I feel loved and appreciated. I feel natural. I feel good about myself."
         ...
         venusHouseHeading3.text = "What form does the shadow take"
         ...
         venusHouseText3.text = "Perhaps I pay no attention to material things. Maybe that behavior hurts me – or maybe other people have to take up the slack created by my irresponsibility or indifference. Perhaps I am drawn to dubious money-making schemes, perhaps even to try crime in some sense of the word. Or maybe, out of insecurity, I feel compelled to support myself in such soul-numbing fashion that I shut down my own heart in order to survive my job."
