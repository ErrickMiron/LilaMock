...
class EighthHousePlanetViewController2: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        venusHouse8.text = "Right at the top of the list is your right to make your own autonomous decisions without anyone telling you what to do. A close second is your right to blow off a little steam if something has annoyed you, and to feel free to do that without anyone looking at you as if you were some kind of serial killer."
...
//
        ...
        plutoFirstHeading1.text = "The Battlefield"
...
//
         ...
         moonSignText.text = "The behaviors that arise from all of the complex emotions, instincts, and issues that are triggered by the process of coupling or mating. Unresolved psychological wounds and how we deal with them—or how they deal with us. The unconscious mind manifesting in our intimate behavior. Human mortality—that is to say, our psychological and spiritual relationship to our own deaths and to the deaths of people with whom we share life."
...
//
         ...
         moonHouseHeading.text = "Strategy"
...
//
         ...
         moonHouseText.text = "Above all, honesty—the inner behavior of truthful self-examination, along with the outward behavior of penetrating interactions with people with whom we have deep bonds. Committed sexuality as one path of the spiritual warrior. Lifelong preparation for the spiritual adventure of death."
...
//
         ...
         venusHouseHeading1.text = "Your objective"
...
//
         ...
         venusHouseText1.text = "Making death our counselor—which is to say that in the light of our mortality, much becomes very clear. We then understand what is important and what is not important. Bringing that wisdom to bear upon the entire length of life. The wasteful futility of lying to ourselves or lying to anyone with whom we are pretending to be intimate. Our objective is to live each day as if it were our last and to love with that kind of transparency, intensity, and nakedness."
         ...
         venusHouseHeading2.text = "How to lose"
         ...
         venusHouseText2.text = "Believing in the illusion of a “magical partner” with whom we can remain in a fairyland of passion forever without making any evolutionary effort; the inevitable cycle of disappointments that follow from such an erroneous belief. Acting as if we think that we will live forever."
...
//         venusHouseHeading3.text = "How to lose"
...
//         venusHouseText3.text = "Believing in the illusion of a “magical partner” with whom we can remain in a fairyland of passion forever without making any evolutionary effort; the inevitable cycle of disappointments that follow from such an erroneous belief. Acting as if we think that we will live forever."
//
