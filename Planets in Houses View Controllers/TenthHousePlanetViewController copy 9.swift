//
//  TenthHousePlanetViewController.swift
//  MVP
//
...
class TenthHousePlanetViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        var moonHouse10 = UILabel(frame: CGRect(x: 20, y: 45, width: 325, height: 120))
        moonHouse10.text = "Those things for you are: You have a sense of mission in the world. You have a right for it to be taken seriously. You have a right not to be pressured to choose between love and work – you have a natural right to both of them. The universe has called you to care for other people – you have a right to be respected and appreciated for that."
        moonHouse10.textColor = .white
        moonHouse10.font = .systemFont(ofSize: 13)
         scrollView.addSubview(moonHouse10)
        moonHouse10.lineBreakMode = .byWordWrapping
        moonHouse10.numberOfLines = 0
...
//
        ...
        plutoFirstHeading1.text = "The Healing I Seek to Give and Receive"
...
//
         ...
         moonSignText.text = "In this lifetime, I resolve to turn myself into a positive gift to my community. I will naturally have my own personal life, separate from my life in the world – but I will also find a way for my heart and soul to express themselves in the form of some larger mission that touches the wider circle around me. I resolve to positively impact the lives of people whom I do not know personally. I do not need to be famous – I only need to leave a mark beyond the immediate framework of my friends and family. "
...
//
         ...
         moonHouseHeading.text = "The Tools You Have Been Given"
...
//
         ...
         moonHouseText.text = "First and foremost, I simply have a mission. I recognize that. There is a genuine need out there in the community which I was born to meet. I have the ability to have a healing impact upon the bodies, minds, or spirits of people whom I do not know in an intimate, two-way-street sort of way. "
...
//
         ...
         venusHouseHeading1.text = "If You Want to Be Happy, You Must Prioritize"
...
//
         ...
         venusHouseText1.text = "Healing you reflexive urge toward self-protection in the face of the world’s various insensitivities. I cannot let those kinds of cautions blind me to my mission. I must prioritize figuring out a way to “get paid” for having a heart and an inner life. Money is not really the issue, but “getting paid” means being recognized and appreciated for giving something to the community which also feels personally meaningful to me. That gift must reflect Mother Moon’s human touch, and not just be some robotic skill set which I have been trained to perform. What Gets Me Down: Realizing that I could have made a real difference in terms of alleviating some degree of suffering somewhere in the world, but that I let fear, self-protection, or simple moodiness prevent me from doing it. "
         ...
         venusHouseHeading2.text = "A Bad Attitude That Could Sabotage You"
         ...
         venusHouseText2.text = "The sense that the best anyone can ever actually do is merely to survive. The sense that the world’s condition is irredeemable and that all I can do is to keep my head down and try not to get hurt. "
