//
//  FirstFirstHousePlanetViewController.swift
//  MVP
//
...
class FirstFirstHousePlanetViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        plutoHouse1.text = "What is it that you really want? Everybody thinks that’s the world’s easiest question. Everyone has a quick answer. But a true answer – not just one we learned on television or the Internet or from the advertising industry – is a precious thing. Lila wonders if you are brave enough and wise enough to know what kind of life will actually make you happy?."
...
//
        ...
        plutoFirstHeading1.text = "Confronting Your Soul-Wounds"
...
//
         ...
         moonSignText.text = "The hurt places in me tend to manifest in bad decisions I make at critical existential crossroads. The pressure is on, and sometimes my wounds make the call rather than my soul. It is not that I am more wounded than other people; rather it is that I tend, often unwittingly, to put my “stuff” on the table rather than keeping it secret. I am capable of behaving self-destructively, but sometimes those wounds involve my creating pain for other people through what I say or do to them. When I am in the grips of my hurt places, I can seem cruel or unnecessarily confrontive."
...
//
         ...
         moonHouseHeading.text = "How They Originated"
...
//
         ...
         moonHouseText.text = "In a prior lifetime, I was in a position of leadership and responsibility in a dark situation in which there were no good, morally acceptable answers. My long-ago adaptation to those circumstances left me with scars that I am trying to heal in this present lifetime."
...
//
         ...
         venusHouseHeading1.text = "How to heal"
...
//
         ...
         venusHouseText1.text = " I must seek companionship with people who are strong enough psychologically that they can accept my raw truthfulness without flinching. With them, I can recover my lost spontaneity. I can stop editing myself or “walking on eggshells.” I will “learn by doing” in this lifetime – and what I am learning is how to move with dignity and self-respect through morally-complex questions where there is often no clear right path."
