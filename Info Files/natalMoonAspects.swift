...
import SwissEphemeris
      ...
      func getNatalMoonAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_moon),String(moon_mercury),String(moon_venus),String(moon_mars),String(moon_jupiter),String(moon_saturn),String(moon_neptune),String(moon_pluto)]
        
          
          print("Moon aspects = \(aspects)")
...
print("HEY YALL \(imageArr)")
          ...
          let moonCompounds = imageArr.filter{ $0.contains("prominence") || $0.contains("growth") || $0.contains("friction") || $0.contains("opportunity") || $0.contains("obstacle") || $0.contains("luck") || $0.contains("agitation") || $0.contains("expansion") || $0.contains("opposition")  }
          for moonCompound in moonCompounds {
             print(" ASPECTS \(moonCompounds)")
