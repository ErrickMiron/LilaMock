...
import SwissEphemeris
      ...
      func getTransitNeptuneAspects() -> [String]  {
...
var aspects: [String] =  [String(venus_moon),String(moon_venus),String(venus_venus),String(venus_mars),String(venus_jupiter),String(venus_saturn),String(venus_uranus),String(venus_neptune),String(venus_pluto),String(sun_venus),String(venus_sun),String(venus_venus),String(mars_venus),String(jupiter_venus),String(saturn_venus),String(uranus_venus),String(neptune_venus),String(pluto_venus),String(mercury_venus),String(venus_mercury)]
