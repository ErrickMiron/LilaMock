...
class HousesCustomTableViewCell: UITableViewCell {
   ...
   //        tableCell.backgroundColor = .darkGray
           ...
           planetText.text = "Sun"
           planetText.font = .systemFont(ofSize: 29)
           ...
           signText.font = UIFont.boldSystemFont(ofSize: signText.font.pointSize)
            ...
            signGlyph.image = UIImage(named: "WhiteSun")
       ...
       public func configure(planetGlyphImageName: String, signGlyphImageName: String, planetImageImageName: String, signTextText: String, planetTextText: String, headerTextText: String)  {
...
//           planetGlyph.frame = CGRect(x: 10, y: 44, width: 12, height: 13)
           ...
           headerText.frame = CGRect(x: 10, y: 50, width: 200, height: 100)
