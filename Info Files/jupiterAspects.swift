...
import SwissEphemeris
      ...
      func getTransitJupiterAspects() -> [String]  {
...
var aspects: [String] =  [String(jupiter_moon),String(jupiter_sun),String(jupiter_mars),String(jupiter_mercury),String(jupiter_saturn),String(jupiter_uranus),String(jupiter_neptune),String(jupiter_pluto),String(jupiter_venus),String(jupiter_sun)]
