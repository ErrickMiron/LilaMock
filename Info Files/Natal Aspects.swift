...
var imageArr = aspects.filter(){ filename in
    singleCharPngPredicate.evaluate(with: filename)
    
}
print("HEY YALL \(imageArr)")

          var compounds = imageArr.filter{ $0.contains("prominence") || $0.contains("growth") || $0.contains("friction") || $0.contains("opportunity") || $0.contains("obstacle") || $0.contains("luck") || $0.contains("agitation") || $0.contains("expansion") || $0.contains("opposition")  }
          for compound in compounds {
             print(" ASPECTS \(compound)")

              
              if compound == sun_venus {
