...
import SwissEphemeris
      ...
      func getNatalNeptuneAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_neptune),String(moon_neptune),String(mercury_neptune),String(venus_neptune),String(mars_neptune),String(saturn_neptune),String(uranus_neptune),String(neptune_pluto),String(jupiter_neptune)]
