...
import SwissEphemeris
      ...
      func getTransitSunAspects() -> [String]  {
...
var aspects: [String] =  [String(sun_moon),String(sun_mercury),String(sun_venus),String(sun_mars),String(sun_jupiter),String(sun_saturn),String(sun_uranus),String(sun_neptune),String(sun_pluto),String(moon_sun),String(mercury_sun),String(venus_sun),String(mars_sun),String(jupiter_sun),String(saturn_sun),String(uranus_sun),String(neptune_sun),String(pluto_sun),String(sun_sun)]
...
let imageArr = aspects.filter(){ filename in
    singleCharPngPredicate.evaluate(with: filename)
          ...
          let sunCompounds = imageArr.filter{ $0.contains("prominence") || $0.contains("growth") || $0.contains("friction") || $0.contains("opportunity") || $0.contains("obstacle") || $0.contains("luck") || $0.contains("agitation") || $0.contains("expansion") || $0.contains("opposition")  }
          for sunCompound in sunCompounds {
              print(" ASPECTS \(sunCompounds)")

              print(" aspected pl \(aspectedPlanets)")
