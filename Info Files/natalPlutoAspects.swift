...
import SwissEphemeris
      ...
      func getNatalPlutoAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_pluto),String(moon_pluto),String(mercury_pluto),String(venus_pluto),String(mars_pluto),String(saturn_pluto),String(uranus_pluto),String(neptune_pluto),String(jupiter_pluto)]
