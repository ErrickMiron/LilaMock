...
import SwissEphemeris
  ...
  func partnerGeocoding(location: String,  completion: @escaping () -> ())  {
...
func getPartnerMajorProgresseDate(latitude: Double, longitude: Double, birthTimeZone: TimeZone) -> Date {
...
//
    ...
    func getPartnerProgressedPlanets (date: Date)  -> [String] {
