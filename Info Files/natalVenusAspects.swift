...
import SwissEphemeris
      ...
      func getNatalVenusAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_venus),String(moon_venus),String(mercury_venus),String(venus_mars),String(venus_jupiter),String(venus_saturn),String(venus_neptune),String(venus_pluto)]
