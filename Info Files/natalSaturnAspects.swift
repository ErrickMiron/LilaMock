...
import SwissEphemeris
      ...
      func getNatalSaturnAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_saturn),String(moon_saturn),String(mercury_saturn),String(venus_saturn),String(mars_saturn),String(saturn_pluto),String(saturn_uranus),String(saturn_neptune),String(jupiter_saturn)]
