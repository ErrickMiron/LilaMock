...
import SwissEphemeris
      ...
      func getTransitMercuryAspects() -> [String]  {
...
var aspects: [String] =  [String(mercury_moon),String(moon_mercury),String(mercury_venus),String(mercury_mars),String(mercury_jupiter),String(mercury_saturn),String(mercury_uranus),String(mercury_neptune),String(mercury_pluto),String(sun_mercury),String(mercury_sun),String(mercury_mercury),String(venus_mercury),String(mars_mercury),String(jupiter_mercury),String(saturn_mercury),String(uranus_mercury),String(neptune_mercury),String(pluto_mercury)]
