...
var partnersSigns = [capricorn, aquarius, pisces, aries, taurus, gemini, cancer, leo, virgo, libra, scorpio, sagittarius]

var mySigns = [gemini, cancer, virgo, taurus, aries, aries, gemini, leo, scorpio, sagittarius, libra]

var transitSigns = [virgo, taurus, libra, taurus, gemini, aries, gemini, aquarius, taurus, pisces, capricorn]

var partnersPlanetSigns = [pisces, capricorn, capricorn, pisces, pisces, cancer, gemini, leo, scorpio,sagittarius, libra]


var transitPlanetSigns = [virgo, taurus, virgo, taurus, aries, aries, gemini, leo, scorpio, sagittarius, libra]
...
var firstHousePlanetImages = [rising, Moon,Saturn]
var secondHousePlanetImages = [Sun, Mercury, Uranus]
...
var planetImages = [Mercury,Venus,Pluto,Jupiter,Saturn,Uranus,Neptune,Mars,Venus,Mercury,Moon,Sun]


var planetImages2 = [Sun,Moon,rising,Mercury,Venus,Mars,Jupiter,Saturn,Uranus,Neptune,Pluto]
