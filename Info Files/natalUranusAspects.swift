...
import SwissEphemeris
      ...
      func getNatalUranusAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_uranus),String(moon_uranus),String(mercury_uranus),String(venus_uranus),String(mars_uranus),String(saturn_uranus),String(uranus_pluto),String(uranus_neptune),String(jupiter_uranus)]
