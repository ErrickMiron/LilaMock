...
import SwissEphemeris
      ...
      func getNatalJupiterAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_jupiter),String(moon_jupiter),String(mercury_jupiter),String(venus_jupiter),String(mars_jupiter),String(jupiter_saturn),String(jupiter_uranus),String(jupiter_neptune),String(jupiter_pluto)]
