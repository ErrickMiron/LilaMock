...
import SwissEphemeris
      ...
      func getNatalMercuryAspects() -> [String]{
...
var plutoAspects = [plutoPlutoAspect?.symbol ?? "",plutoNeptuneAspect?.symbol ?? "",plutoJupiterAspect?.symbol ?? "",neptuneMoonAspect?.symbol ?? ""]
          ...
          var aspects: [String] =  [String(sun_mercury),String(moon_mercury),String(mercury_venus),String(mercury_mars),String(mercury_jupiter),String(mercury_saturn),String(mercury_neptune),String(mercury_pluto),String(mercury_uranus)]
