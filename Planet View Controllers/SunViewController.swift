...
//        var sunSignHeading1 = UILabel(frame: CGRect(x: 35, y: 590, width: 300, height: 20))
//        sunSignHeading1.text = "Where You Need a Helping Hand"
//        sunSignHeading1.font = .systemFont(ofSize: 13)
//        sunSignHeading1.textColor = .black
//        sunSignHeading1.font = UIFont.boldSystemFont(ofSize: sunSignHeading1.font.pointSize)
//         scrollView.addSubview(sunSignHeading1)
//
...
//
//
        var sunInSign = UILabel(frame: CGRect(x: 35, y: 300, width: 300, height: 20))
        sunInSign.text = "Sun in Gemini"
        sunInSign.font = .systemFont(ofSize: 13)
        sunInSign.textColor = .lightGray

        scrollView.addSubview(sunInSign)
    
        
        var sunSignText1 = UILabel(frame: CGRect(x: 35, y: 320, width: 300, height: 200))
        sunSignText1.text = "Evolutionary Aim: I resolve to cultivate “a beginner’s mind”—that is to say, I celebrate questions more than I celebrate answers. I accept the principle that whatever I might see, the truth is beyond that—in other words, the wiser I become, the greater my area of contact with the unknown becomes. I celebrate that too. I realize that, in pursuing such questions, I find my true voice. Being true to this path is the source of my energy, my self-respect and my recuperative powers, as well as the foundation of my spiritual sanity. "
        
        sunSignText1.font = .systemFont(ofSize: 13)
        sunSignText1.textColor = .lightGray
        sunSignText1.lineBreakMode = .byWordWrapping
        sunSignText1.numberOfLines = 0
        scrollView.addSubview(sunSignText1)
       
      
        var sunSignText2 = UILabel(frame: CGRect(x: 35, y: 530, width: 300, height: 200))
        sunSignText2.text = "Core Values: Listening teaches me more than talking ever does. I would rather learn something than to be considered an expert. I am drawn to people who surprise me and stretch the boundaries of my understanding. I celebrate the deep energetic mystery behind even a simple conversation—the way what might be called “small talk” weaves energy bodies together, if only we are mindful of what is really happening behind the words."
        
        sunSignText2.font = .systemFont(ofSize: 13)
        sunSignText2.textColor = .lightGray
        sunSignText2.lineBreakMode = .byWordWrapping
        sunSignText2.numberOfLines = 0
        scrollView.addSubview(sunSignText2)
       
        
        var sunSignText3 = UILabel(frame: CGRect(x: 35, y: 740, width: 300, height: 200))
        sunSignText3.text = "Strategy: I will resolve to avoid boredom, even when it comes cleverly disguised as practicality, responsibility, or maturity. I will pack the experience of many lifetimes into one lifetime. I will speak up—but I will also listen carefully. I am energized by questions; I am thrilled when confronted with paradox, the inexplicable, or the miraculous. I seek them. I recognize that when I am proven wrong, while the experience is unpleasant, it is the portal to higher wisdom."
        
        sunSignText3.font = .systemFont(ofSize: 13)
        sunSignText3.textColor = .lightGray
        sunSignText3.lineBreakMode = .byWordWrapping
        sunSignText3.numberOfLines = 0
        scrollView.addSubview(sunSignText3)
        
        
        
        var sunSignText4 = UILabel(frame: CGRect(x: 35, y: 910, width: 300, height: 200))
        sunSignText4.text = "Tools: I was born with restless, insatiable curiosity. Language skills arise in me without much effort. I am a natural student and a natural teacher. I am energetic; my mind quickly engages with anything novel or unexpected."
        
        sunSignText4.font = .systemFont(ofSize: 13)
        sunSignText4.textColor = .lightGray
        sunSignText4.lineBreakMode = .byWordWrapping
        sunSignText4.numberOfLines = 0
        scrollView.addSubview(sunSignText4)
        

        var sunSignText5 = UILabel(frame: CGRect(x: 35, y: 1060, width: 300, height: 200))
        sunSignText5.text = "Dealing with the Shadow: I recognize that my natural curiosity can scatter my attention in too many directions. I cultivate focus, strategy and my capacity for linear thought. I strive to make a distinction between serendipitous curiosity and simply being distracted; I make a conscious effort to stay on the correct side of that line. I am happy to talk, but I try to spend an equal amount of time listening."

        sunSignText5.font = .systemFont(ofSize: 13)
        sunSignText5.textColor = .lightGray
        sunSignText5.lineBreakMode = .byWordWrapping
        sunSignText5.numberOfLines = 0
        scrollView.addSubview(sunSignText5)
