//
//  TwelthHouseViewController.swift
//  MVP
//
...
class TwelthHouseViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        HouseHeader1.text = "The House of Troubles"
...
//        view.addSubview(HouseDescription1)
        ...
        HouseDescription1.text = "The twelfth house often brings setbacks, even if our navigation is good. But we need not respond to trouble with self-pity. We can use it. We can turn inward. We can let go. Whenever trouble strikes, each of us has a built-in escape route. We can focus on a peaceful place deep within us, a place that is always there, waiting. Every successful twelfth house navigation involves activating those mental circuits. We can withdraw for a while into our depths, feeling that endless reservoir of creativity and life and resilience within us. And feeling that, we can gracefully let go of a set of dying circumstances, knowing that we can begin again. Such letting go is never easy. Those dying circumstances are dear to us. We are attached to them. They are the foundation of our identity in the world. But our identity in the world is a transitory phenomenon. Only consciousness itself is eternal. Nothing else matters. Grasp that, and the House of Troubles is troubled no longer. It is the House of Wisdom."
        ...
        HouseWrong1.text = "When your relationship with these energies are going through times of challenge, you will know because of the presence of a blurry, confused, uncertain self-image, Escapism; abusive, self-destructive relationships with alcohol, food, sleep, sex, television, and other “drugs”. Hypersensitivity, mental imbalance, schizophrenia. Chronic “bad luck.”"
...
extension TwelthHouseViewController: UITableViewDataSource, UITableViewDelegate {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return twelthHousePlanets.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       cell.configure(planetGlyphImageName: "\(planetss[indexPath.row])", signGlyphImageName: "\(twelth_h_signs[indexPath.row])", planetImageImageName: "\(twelfthHousePlanetImages[indexPath.row])", signTextText: "\(twelth_h_signs[indexPath.row])", planetTextText: "\(twelthHousePlanets[indexPath.row])", headerTextText: "\(twelthHouseTexts[indexPath.row])")
